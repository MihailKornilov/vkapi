...
(b.addClass("busy"),$.post(AJAX_MAIN,a,function(a){a.success?b.after(a.html).remove():b.removeClass("busy")},"json"))}).on("click","#_remind-show-all",function(){$("._remind-unit").slideDown(200);$(this).remove()}).ready(function(){$("#_remind-status").length&&$("#_remind-status")._radio(remindSpisok)});
