...
a+"</SPAN>",top:-48,left:126,indent:40,show:1,remove:1})},_wait=function(a){$("#_wait").remove();!1===a?_backfon(!1):($("body").append('<div id="_wait" class="_busy"></div>'),_backfon($("#_wait")),$("#_wait").css("top",$(this).scrollTop()+200+VK_SCROLL))},_br=function(a){return a.replace(RegExp("<br />","g"),"\n")},_copySel=function(a,c){for(var b=[],d=0;d<a.length;d++){var e=a[d];e.uid!=c&&b.push(e)}return b},_dialog=function(a){function c(){f.remove();_backfon(!1);0==d&&(DIALOG_MAXHEIGHT=0);_fbhs()}
function b(a){g.vkHint({msg:'<span class="red">'+a+"</span>",top:-48,left:m-90,indent:40,show:1,remove:1})}$(this).attr("id");a=$.extend({width:360,top:100,mb:0,padding:10,head:"head: Название заголовка",load:0,"class":"",content:"content: содержимое центрального поля",submit:function(){},cancel:function(){},butSubmit:"Внести",butCancel:"Отмена"},a);a.load&&(a.content='<div class="load _busy"><div class="ms">В процессе загрузки произошла ошибка.</div></div>');var d=$(".dFrame").length,e='<div class="_dialog"><div class="head"><a class="img_del"></a>'+
a.head+'</div><div class="dcntr"><iframe class="dFrame" name="dFrame'+d+'"></iframe><div class="content'+(a["class"]?" "+a["class"]+"_dialog":"")+'"'+(a.padding?' style="padding:'+a.padding+'px"':"")+">"+a.content+'</div></div><div class="bottom"><button class="vk submit'+(a.butSubmit?"":" dn")+'">'+a.butSubmit+"</button>"+(a.butCancel?'<button class="vk cancel">'+a.butCancel+"</button>":"")+"</div></div>";0==d&&(DIALOG_MAXHEIGHT=0);var f=$("body").append(e).find("._dialog:last"),e=f.find(".content"),
g=f.find(".bottom"),l=g.find(".submit"),m=Math.round(a.width/2);f.find(".head .img_del").click(c);l.click(function(){a.submit()});g.find(".cancel").click(function(b){b.stopPropagation();a.cancel();c()});e.find("input").keyEnter(a.submit);_backfon();f.css({width:a.width+"px",top:$(window).scrollTop()+VK_SCROLL+a.top+"px",left:313-m+"px","z-index":ZINDEX+5});window["dFrame"+d].onresize=function(){for(var b=$(".dFrame"),c=0,d=0;d<b.length;d++){var e=b.eq(d).height();e>c&&(c=e)}b=c+VK_SCROLL+80+a.mb;
DIALOG_MAXHEIGHT!=b&&(DIALOG_MAXHEIGHT=b,_fbhs())};return{close:c,process:function(){l.addClass("_busy")},abort:function(a){l.removeClass("_busy");a&&b(a)},bottom:g,content:e,err:b,loadError:function(){f.find(".load").removeClass("_busy")},butSubmit:function(a){l[(a?"remove":"add")+"Class"]("dn");l.html(a)},submit:function(b){a.submit=b}}},_dialogDel=function(a){a=$.extend({id:0,head:"записи",info:"",op:"_del",func:function(){}},a);var c=_dialog({head:"Удаление "+a.head,padding:30,content:(a.info?
'<div class="_info">'+a.info+"</div>":"")+'<center class="red">Подтвердите удаление<br /><b>'+a.head+"</b>.</center>",butSubmit:"Удалить",submit:function(){var b={op:a.op,id:a.id};c.process();$.post(AJAX_MAIN,b,function(b){b.success?(c.close(),_msg("Удалено"),a.func(b)):(c.abort(),c.err(b.text))},"json")}})},_tooltip=function(a,c,b){return' _tooltip"><div class="ttdiv"'+(c?' style="left:'+c+'px"':"")+'><div class="ttmsg">'+a+'</div><div class="ttug'+(b?" "+b:"")+'"></div></div>'},_parent=function(a,
c){c=c||"TR";var b=10,d=0,e="."==c[0];for(e&&(c=c.substr(1));!d;)a=a.parent(),d=e?a.hasClass(c):a[0].tagName==c,--b||(d=1);return a},_busy=function(a){var c=$("#_menu");if(0===a)c.removeClass("_busy");else{if(c.hasClass("_busy"))return!0;c.addClass("_busy")}},_filterSpisok=function(a,c,b){b&&(a[b]=c);a.page=1;_scroll("clear");c=a.op.split("_spisok")[0];for(var d in a)"op"!=d&&"page"!=d&&"type_id"!=d&&_cookie(COOKIE_PREFIX+c+"_"+d,escape(a[d]))},_nextCallback=function(){},_yearAss=function(a){var c=
...
$.fn._radio=function(a){function c(a){$(document).off("click","#"+e+"_radio .on,#"+e+"_radio .off");$(document).on("click","#"+e+"_radio .on,#"+e+"_radio .off",function(){a(_num(b.val()),e)})}var b=$(this),d,e=b.attr("id");switch(typeof a){case "number":case "string":d=b.parent();if(d.hasClass("_radio")){d.find(".on").removeClass("on").addClass("off");var f=d.find("div");for(d=0;d<f.length;d++){var g=f.eq(d);if(a==g.attr("val")){g.addClass("on").removeClass("off");break}}b.val(a)}return b;case "function":return c(a),
b;case "object":if("length"in a){f=$("#"+e+"_radio").find("div");for(d=0;d<f.length;d++)g=f.eq(d),g.html("<s></s>"+a[d].title);return b}}a=$.extend({title0:"",spisok:[],light:0,right:15,block:1,func:function(){}},a);var f="",g=b.val(),l=[];a.title0&&(l=[{uid:0,title:a.title0}]);for(d=0;d<a.spisok.length;d++)l.push(a.spisok[d]);for(d=0;d<l.length;d++)var m=l[d],f=f+('<div class="'+(g==m.uid?"on":"off")+(a.light?" l":"")+'" val="'+m.uid+'"'+(a.right?' style="margin-right:'+a.right+'px"':"")+"><s></s>"+
m.title+"</div>");b.wrap('<div class="_radio'+(a.block?" block":"")+'" id="'+e+'_radio">');b.after(f);c(a.func);return b};
