var VK_SCROLL=0,COOKIE_PREFIX=APP_ID+"_"+VIEWER_ID+"_",ZINDEX=0,BC=0,FB,FH,FB_HEIGHT=0,DIALOG_MAXHEIGHT=0,FOTO_HEIGHT=0,REGEXP_NUMERIC=/^\d+$/,REGEXP_NUMERIC_MINUS=/^-?\d+$/,REGEXP_CENA=/^[\d]+(.[\d]{1,2})?(,[\d]{1,2})?$/,REGEXP_CENA_MINUS=/^-?[\d]+(.[\d]{1,2})?(,[\d]{1,2})?$/,REGEXP_MS=/^[\d]+(.[\d]{1,3})?(,[\d]{1,3})?$/,REGEXP_DATE=/^(\d{4})-(\d{1,2})-(\d{1,2})$/,MONTH_DEF={1:"Январь",2:"Февраль",3:"Март",4:"Апрель",5:"Май",6:"Июнь",7:"Июль",8:"Август",9:"Сентябрь",10:"Октябрь",11:"Ноябрь",12:"Декабрь"},
MONTH_DAT={1:"января",2:"февраля",3:"марта",4:"апреля",5:"мая",6:"июня",7:"июля",8:"августа",9:"сентября",10:"октября",11:"ноября",12:"декабря"},WEEK_NAME={0:"вс",1:"пн",2:"вт",3:"ср",4:"чт",5:"пт",6:"сб",7:"вс"},hashLoc,hashSet=function(a){if(a||a.p){hashLoc=a.p;var c=!0;switch(a.p){case "client":"info"==a.d&&(hashLoc+="_"+a.id);break;case "zayav":"info"==a.d?hashLoc+="_"+a.id:"add"==a.d?hashLoc+="_add"+(_num(a.id)?"_"+a.id:""):a.d||(c=!1);break;case "zp":"info"==a.d?hashLoc+="_"+a.id:c=!1;break;
default:a.d&&(hashLoc+="_"+a.d,a.d1&&(hashLoc+="_"+a.d1))}c&&VK.callMethod("setLocation",hashLoc)}},scannerWord="",scannerTime=0,scannerTimer,scannerDialog,scannerDialogShow=!1,charSpisok={48:"0",49:1,50:2,51:3,52:4,53:5,54:6,55:7,56:8,57:9,65:"A",66:"B",67:"C",68:"D",69:"E",70:"F",71:"G",72:"H",73:"I",74:"J",75:"K",76:"L",77:"M",78:"N",79:"O",80:"P",81:"Q",82:"R",83:"S",84:"T",85:"U",86:"V",87:"W",88:"X",89:"Y",90:"Z",189:"-"},_scroll=function(a,c){var b=_cookie("p"),d=_cookie("d");if(!b)return 0;
b=COOKIE_PREFIX+"scroll_"+b+(d||"");d=_cookie(b+"_unit");if("set"==a)_cookie(b,VK_SCROLL),c&&_cookie(b+"_unit",c);else if("page"==a)_cookie(b+"_page",c);else if("clear"==a)_cookie(b,0),_cookie(b+"_page",1);else return d&&$("#"+d).css("position","relative").append('<div id="unit-select-show"></div>').find("#unit-select-show").animate({opacity:0.9},200).animate({opacity:0},900,function(){$("#unit-select-show").remove()}),_num(_cookie(b))},pinLoad=function(a){$("#pin").focus().keydown(function(){$(".red").html("&nbsp;")}).keyup(function(){7*
...
c+30;_fbhs()},_cookie=function(a,c){if(void 0!==c){var b=new Date;b.setDate(b.getDate()+1);document.cookie=a+"="+c+"; path=/; expires="+b.toGMTString();return""}for(var b=document.cookie.split("; "),d=0;d<b.length;d++){var e=b[d].split("=");if(e[0]==a)return e[1]}return""},sortable=function(){$("._sort").sortable({axis:"y",update:function(){if($(this).hasClass("no"))return!0;for(var a=$(this).find("dd"),c=[],b=0;b<a.length;b++){var d=_num(a.eq(b).attr("val"));d&&c.push(d)}a={op:"sort",table:$(this).attr("val"),
ids:c.join()};$.post(AJAX_MAIN,a,function(){},"json")}})},_toSpisok=function(a){var c=[];for(k in a)c.push({uid:k,title:a[k]});return c},_toAss=function(a){for(var c=[],b=0;b<a.length;b++)c[a[b].uid]=a[b].title;return c},_end=function(a,c){2==c.length&&c.push(c[1]);var b=c[2];if(1!=Math.floor(a/10%10))switch(a%10){case 1:b=c[0];break;case 2:b=c[1];break;case 3:b=c[1];break;case 4:b=c[1]}return b},_bool=function(a){return 1==a?1:0},_num=function(a,c){return(c?REGEXP_NUMERIC_MINUS.test(a):REGEXP_NUMERIC.test(a))?
1*a:0},_cena=function(a,c){"string"==typeof a&&(a=a.replace(",","."));return 0==a?0:c&&REGEXP_CENA_MINUS.test(a)?1*a:REGEXP_CENA.test(a)?1*a:0},_ms=function(a){"string"==typeof a&&(a=a.replace(",","."));return 0!=a&&REGEXP_MS.test(a)?1*a:0},_fbhs=function(){var a;0<FOTO_HEIGHT?(a=FOTO_HEIGHT,FB.height(a)):(0==DIALOG_MAXHEIGHT&&FB.height("auto"),a=FB.height(),a<DIALOG_MAXHEIGHT&&(a=DIALOG_MAXHEIGHT,FB.height(a)));FB_HEIGHT!=a&&(FB_HEIGHT=a,VK.callMethod("resizeWindow",625,a))},_backfon=function(a){function c(){BC--;
...
0==d&&(DIALOG_MAXHEIGHT=0);var f=$("body").append(e).find("._dialog:last"),e=f.find(".content"),g=f.find(".bottom"),l=g.find(".submit"),m=Math.round(a.width/2);f.find(".head .img_del").click(c);l.click(function(){a.submit()});g.find(".cancel").click(function(b){b.stopPropagation();a.cancel();c()});e.find("input").keyEnter(a.submit);_backfon();f.css({width:a.width+"px",top:$(window).scrollTop()+VK_SCROLL+a.top+"px",left:313-m+"px","z-index":ZINDEX+5});window["dFrame"+d].onresize=function(){for(var b=
