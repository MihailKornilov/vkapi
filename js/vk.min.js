...
$.fn._rubric=function(a){function c(b){RUBRIC_SUB_SPISOK[b]&&e._select({width:153,title0:"подрубрика не выбрана",spisok:RUBRIC_SUB_SPISOK[b],func:function(){a.func()}})}var b=$(this).attr("id");if(b){a=$.extend({func:function(){}},a);var d=$("#"+b),e=$("#"+b+"_sub");d._select({width:100,title0:"не выбрана",spisok:RUBRIC_SPISOK,func:function(b){e.val(0)._select("remove");c(b);a.func()}});$("#"+b+"_select").css("margin-right",5);c(d.val())}};
