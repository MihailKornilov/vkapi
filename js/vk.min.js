...
a.func(0)}})}window.ATTACH||(ATTACH={});var e=$(this),f=_num(e.val());a=$.extend({zayav_id:0,zayav_save:0,func:function(){}},a);e.wrap('<div class="_attach">');e.parent().append('<a class="_attach-add">прикрепить файл</a>');var h=e.parent(),g=h.find("._attach-add");f&&h.addClass("ex");g.click(function(){function b(){var a=_cookie("_attached");0!=a&&(clearInterval(s),g.removeClass("_busy"),u.css("visibility","visible"),1==a&&(f=_cookie("_attached_id"),$.post(AJAX_MAIN,{op:"attach_get",id:f},function(a){a.success&&
...
butSubmit:"",submit:function(){var b={op:"attach_save",id:f,zayav_id:a.zayav_id,zayav_save:a.zayav_save,name:$.trim($("#name").val())};b.name?(d.process(),$.post(AJAX_MAIN,b,function(b){d.abort();b.success&&(d.close(),h.addClass("ex"),e.val(f),ATTACH[f]=b.arr,c(),a.func(f))},"json")):d.err("Не указано название файла")}}),l=$("#attach-add-tab"),g=l.find(".vk"),q=l.find("form"),u=$("#file"),s;u.change(function(){u.css("visibility","hidden");g.addClass("_busy");_cookie("_attached",0);_cookie("_attached_id",
