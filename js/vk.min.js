...
(new Date).getFullYear(),b=c+1,d=[];a=_num(a);2E3<a&&a<c&&(c=a);a>b&&(b=a);for(a=c;a<=b;a++)d[a]=a;return d},_checkAll=function(a,c){for(var b=$("._check"),d=b.length,e=[],f=0;f<d;f++){var h=b.eq(f),g=_num(h.attr("id").split("_check")[0].split("ch")[1]);g&&("change"==a?$("#ch"+g)._check(c):_num(h.find("input").val())&&e.push(g))}return"array"==a?e:e.join()};
