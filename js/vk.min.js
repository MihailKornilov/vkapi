...
D[b?"show":"hide"](),b||!b&&!a.write_save)t.val(z[b]?z[b].replace(/&quot;/g,'"'):""),A[0==b?"show":"hide"]()}function g(b){b=parseInt(b.attr("val"));var c;a.multiselect&&((!a.title0&&!b||0<b)&&t.before('<div class="multi">'+z[b]+'<span class="x" val="'+b+'"></span></div>'),l(b,!0));f(b);for(h=0;h<a.spisok.length;h++){var d=a.spisok[h];if(d.uid==b){c=d;break}}a.func(b,p,c);C=t.val()}function l(b,d){var e=G.find(".multi"),f=0;w=e.length;for(h=0;h<w;h++){var g=e.eq(h).width();f+g>v+4&&(f=0);f+=g+5+2}f=
v-f;t.width(25>f?v:f);void 0!==b&&(F[b]=d,c(),(!a.title0&&0==b||0<b)&&t.val(""));A[w?"hide":"show"]()}function m(){if(!x.hasClass("rs")){x.addClass("rs");var a=y.find(".selun"),c=y[0];a.removeClass("ov");for(h=0;h<a.length;h++){var d=a.eq(h);if(d.attr("val")==r){d.addClass("ov");d=d[0];a=d.offsetTop+d.offsetHeight;170<a&&(d=250,B>a&&(d-=120<B-a?120:B-a),c.scrollTop=a-d);break}}$(document).on("click."+p+"_select",s).on("keydown."+p+"_select",b)}}function s(){t.is(":focus")||(x.removeClass("rs"),a.write&&
!r&&(t.val()&&!a.write_save&&(t.val(""),a.funcKeyup("")),f(0),a.func(0,p)),$(document).off("click."+p+"_select").off("keydown."+p+"_select"))}var n=$(this),h,q,p=n.attr("id"),r=n.val()||0;if(p){switch(typeof a){default:case "number":case "string":q=window[p+"_select"];switch(a){case "process":q.process();break;case "cancel":q.cancel();break;case "title":return q.title();case "inp":return q.inp();case "focus":q.focus();break;case "remove":$("#"+p+"_select").remove();window[p+"_select"]=null;break;
default:if(REGEXP_NUMERIC_MINUS.test(a)){var u=q.o.write_save;q.o.write_save=0;q.value(a);q.o.write_save=u}}return n;case "object":if("length"in a)return q=window[p+"_select"],q.spisok(a),n;if(!("spisok"in a))return n}a=$.extend({width:150,disabled:0,block:!1,bottom:0,title0:"",spisok:[],limit:0,write:0,write_save:0,nofind:"Список пуст",multiselect:0,func:function(){},funcAdd:null,funcKeyup:e},a);a.clear=a.write&&!a.multiselect;a.multiselect&&(a.write=!0);var v=a.width-17-5-4;a.funcAdd&&(v-=18);a.clear&&
(v-=18,r=_num(r));q='<div class="_select'+(a.disabled?" disabled":"")+'" id="'+p+'_select" style="width:'+a.width+"px"+(a.block?";display:block":"")+(a.bottom?";margin-bottom:"+a.bottom+"px":"")+'"><div class="title0bg">'+a.title0+'</div><table class="seltab"><tr><td class="selsel"><input type="text" class="selinp" style="width:'+v+"px"+(a.write&&!a.disabled?"":";cursor:default")+'"'+(a.write&&!a.disabled?"":" readonly")+" />"+(a.clear?"<div"+(r?"":' style="display:none"')+' class="clear'+_tooltip("Очистить",
-49,"r")+"</div>":"")+(a.funcAdd?'<td class="seladd">':"")+'<td class="selug"></table><div class="selres" style="width:'+a.width+'px"></div></div>';n.next().remove("._select");n.after(q);var x=n.next(),t=x.find(".selinp"),D=x.find(".clear"),G=x.find(".selsel"),y=x.find(".selres"),B,A=x.find(".title0bg"),z,E=[],F={},w=0,H=/(<[\/]?[_a-zA-Z0-9=\"' ]*>)/i,I={38:1,40:1,13:1,27:1,9:1};d();if(a.multiselect){if(0!=r)for(q=r.split(","),h=0;h<q.length;h++)F[q[h]]=!0,t.before('<div class="multi">'+z[q[h]]+'<span class="x" val="'+
q[h]+'"></span></div>');l()}a.funcAdd&&!a.disabled&&x.find(".seladd").click(function(){a.funcAdd(p)});c();f(r);var C=t.val();a.disabled||($(document).off("click","#"+p+"_select .selug").on("click","#"+p+"_select .selug",m).off("click","#"+p+"_select .selsel").on("click","#"+p+"_select .selsel",function(){t.focus()}).off("click","#"+p+"_select .selun").on("click","#"+p+"_select .selun",function(){g($(this))}).off("mouseenter","#"+p+"_select .selun").on("mouseenter","#"+p+"_select .selun",function(){y.find(".ov").removeClass("ov");
$(this).addClass("ov")}).off("click","#"+p+"_select .x").on("click","#"+p+"_select .x",function(b){b.stopPropagation();b=$(this).attr("val");$(this).parent().remove();l(b,!1);f(b);a.func(b,p)}),t.focus(function(){m();a.write&&A.css("color","#ccc")}).blur(function(){a.write&&A.css("color","#888")}).keyup(function(b){I[b.keyCode]||(A[t.val()||w?"hide":"show"](),D[t.val()?"show":"hide"](),C!=t.val()&&(C=t.val(),a.funcKeyup(C),n.val(0),r=0))}),D.click(function(b){b.stopPropagation();f(0);t.val("");A.show();
a.func(0,p)}));n.o=a;n.value=f;n.process=function(){t.addClass("_busy")};n.cancel=function(){t.removeClass("_busy")};n.spisok=function(b){a.spisok=b;d();c();n.cancel()};n.title=function(){return z[n.val()]};n.inp=function(){return t.val()};n.focus=function(){t.focus()};return window[p+"_select"]=n}};
