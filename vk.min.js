...
d=g.find(".content"),e=g.find(".bottom"),f=e.find(".vkButton");g.find(".head .img_del").click(c);f.find("button").click(a.submit);e.find(".vkCancel").click(function(){a.cancel();c()});_backfon();g.css({width:a.width+"px",top:$(window).scrollTop()+VK_SCROLL+a.top+"px",left:313-Math.round(a.width/2)+"px","z-index":ZINDEX+5});window["dFrame"+b].onresize=function(){for(var a=$(".dFrame"),b=0,c=0;c<a.length;c++){var d=a.eq(c).height();d>b&&(b=d)}a=b+VK_SCROLL+80;DIALOG_MAXHEIGHT!=a&&(DIALOG_MAXHEIGHT=
a,_fbhs())};return{close:c,process:function(){f.addClass("_busy")},abort:function(){f.removeClass("_busy")},bottom:e,content:d,loadError:function(){g.find(".load").removeClass("_busy")}}};
...
k.keyEnter(g);n.click(g);$("#fotoUpload .webcam a").click(e)})};
...
$.fn._calendar=function(a){function c(){var c,d="<tr>",e=m.getFullYear(),g=m.getMonth()+1,f=m.getDate(),h;h=(new Date(a.year,a.mon-1,1)).getDay();h=0==h?7:h;var l=e==a.year&&g==a.mon,r=0==a.lost,v=a.year==k&&a.mon==n,q;c=a.year;q=a.mon;q--;0==q&&(q=12,c--);q=32-(new Date(c,q,32)).getDate();if(1<h)for(c=0;c<h-1;c++)d+="<td>";for(c=1;c<=q;c++){var u="";a.year<e?u=" lost":a.year==e&&a.mon<g?u=" lost":a.year==e&&a.mon==g&&c<f&&(u=" lost");d+='<td class="'+(!u||u&&!r?" sel":"")+(l&&c==f?" b":"")+(v&&c==
p?" set":"")+u+'"'+(!u||u&&!r?' val="'+c+'"':"")+">"+c;h++;8==h&&c!=q&&(d+="<tr>",h=1)}t.html(d).find(".sel").click(b)}function b(){k=a.year;n=a.mon;p=$(this).attr("val");s.html(p+" "+MONTH_DAT[n]+" "+k);f.val(d());a.func(d())}function d(){return k+"-"+(10>n?"0":"")+n+"-"+(10>p?"0":"")+p}function g(b){b.stopPropagation();a.mon--;0==a.mon&&(a.mon=12,a.year--);q.html(MONTH_DEF[a.mon]+" "+a.year);c()}function e(b){b.stopPropagation();a.mon++;13==a.mon&&(a.mon=1,a.year++);q.html(MONTH_DEF[a.mon]+" "+
a.year);c()}var f=$(this),h=f.attr("id"),l=f.val(),m=new Date;a=$.extend({year:m.getFullYear(),mon:m.getMonth()+1,day:m.getDate(),lost:0,func:function(){},place:"right"},a);REGEXP_DATE.test(l)&&(l=l.split("-"),a.year=l[0],a.mon=Math.abs(l[1]),a.day=Math.abs(l[2]));f.wrap('<div class="_calendar" id="'+h+'_calendar">');f.after('<div class="calinp">'+a.day+" "+MONTH_DAT[a.mon]+" "+a.year+'</div><div class="calabs"></div>');var k=a.year,n=a.mon,p=a.day,s=f.next(),r=s.next(),q,t;f.val(d());s.click(function(b){if(!r.html()){b.stopPropagation();
...
r.find(".calback").click(g);r.find(".calnext").click(e);q=r.find(".calmon");t=r.find(".caldays");c()}})};
...
$.fn._dropdown=function(a){function c(c){b();a.nosel||(d.val(c),s.html(h[c])[(a.title0&&!c?"add":"remove")+"Class"]("grey"),q.html(h[c]))}function b(){n&&(clearTimeout(n),n=0)}var d=$(this),g=d.attr("id");if("number"==typeof a||"string"==typeof a){switch(a){case "remove":d.next().remove("._dropdown");break;default:window[g+"_dropdown"].value(a)}return d}a=$.extend({head:"",headgrey:0,title0:"",spisok:[],func:function(){},nosel:0},a);var e,f=1*d.val()||0,h=function(){for(var b=a.title0?{0:a.title0}:
{},c=0;c<a.spisok.length;c++){var d=a.spisok[c];b[d.uid]=d.title}return b}(),l=a.head||a.title0,m=a.spisok.length,k=a.title0?'<a class="ddu grey'+(m?"":" last")+(f?"":" seld")+'" val="0">'+a.title0+"</a>":"",n=0;d.val(f);for(e=0;e<m;e++){var p=a.spisok[e],k=k+('<a class="ddu'+(e==m-1?" last":"")+(f==p.uid?" seld":"")+'" val="'+p.uid+'">'+p.title+"</a>");f==p.uid&&(l=p.title)}d.next().remove("._dropdown");d.after('<div class="_dropdown" id="'+g+'_dropdown"><a class="ddhead'+(a.headgrey||a.title0?" grey":
"")+'">'+l+'</a><div class="ddlist"><div class="ddsel">'+l+"</div>"+k+"</div></div>");var f=d.next(),s=f.find(".ddhead"),r=f.find(".ddlist"),q=r.find(".ddsel"),t=r.find(".ddu");s.click(function(){b();r.show()});q.click(function(){b();r.hide()});t.click(function(){var b=$(this),d=parseInt(b.attr("val"));c(d);a.nosel||b.addClass("seld");r.hide();a.func(d)}).mouseenter(function(){t.removeClass("seld")});r.on({mouseleave:function(){n=setTimeout(function(){r.fadeOut(200)},500)},mouseenter:b});d.value=
function(a){c(a);r.find(".seld").removeClass("seld");for(e=0;e<t.length;e++){var b=t.eq(e);if(b.attr("val")==a){b.addClass("seld");break}}};return window[g+"_dropdown"]=d};
...
a.before("<div class=hint>"+e+"</div>");var f=a.prev(),h=f.find(".hint_table:first");0<b.width&&h.find(".cont_table:first").width(b.width);var e=h.width(),l=h.height();h.hide().css("visibility","visible");var m=b.top,k=b.left;switch(b.ugol){case "top":m=b.top-15;l=h.find(".ugttd:first");"center"==b.indent?l.css("text-align","center"):"right"==b.indent?l.css("text-align","right"):"left"==b.indent?l.css("text-align","left"):isNaN(b.indent)||(l.css("text-align","left"),10>b.indent&&(b.indent=10),b.indent>
e&&(b.indent=e-28),h.find(".ugt:first").css("margin-left",b.indent+"px"));break;case "right":k=b.left+25;e=h.find(".ugrtd:first");"center"==b.indent?e.css("vertical-align","middle"):"bottom"==b.indent?e.css("vertical-align","bottom"):isNaN(b.indent)||(3>b.indent&&(b.indent=3),b.indent>l&&(b.indent=l-31),h.find(".ugr:first").css("margin-top",b.indent+"px"));break;case "bottom":m=b.top+15;l=h.find(".ugbtd:first");"center"==b.indent?l.css("text-align","center"):"right"==b.indent?l.css("text-align","right"):
"left"==b.indent?l.css("text-align","left"):isNaN(b.indent)||(l.css("text-align","left"),10>b.indent&&(b.indent=10),b.indent>e&&(b.indent=e-28),h.find(".ugb:first").css("margin-left",b.indent+"px"));break;case "left":k=b.left-25,e=h.find(".ugltd:first"),"center"==b.indent?e.css("vertical-align","middle"):"bottom"==b.indent?e.css("vertical-align","bottom"):isNaN(b.indent)||(3>b.indent&&(b.indent=3),b.indent>l&&(b.indent=l-31),h.find(".ugl:first").css("margin-top",b.indent+"px"))}a.off(b.event+".hint");
...
$.fn._select=function(a){function c(){var b=a.title0&&!a.multiselect?'<div class="selun title0" val="0">'+a.title0+"</div>":"";for(e=0;e<a.spisok.length;e++){var c=a.spisok[e];r[c.uid]||(b+='<div class="selun" val="'+c.uid+'">'+(c.content||c.title)+"</div>")}k.html(b).find(".selun:last").addClass("last");250<k.height()&&k.css("border-bottom","#CCC solid 1px").height(250).find(".last").css("border-bottom",0)}function b(b){if(a.multiselect)if(q){b=p.find(".x");var c=[];for(e=0;e<b.length;e++)c.push(b.eq(e).attr("val"));
g.val(c.join())}else g.val(0);else g.val(b),n.val(s[b]),n[(0==b&&a.title0?"add":"remove")+"Class"]("title0")}function d(b,d){var f=p.find(".multi"),g=0;q=f.length;for(e=0;e<q;e++){var h=f.eq(e).width();g+h>l+4&&(g=0);g+=h+5+2}g=l-g;n.width(25>g?l:g);void 0!==b&&(r[b]=d,c(),(!a.title0&&0==b||0<b)&&n.val("").focus());t[q?"hide":"show"]()}var g=$(this),e,f=g.attr("id"),h=g.val()||0;if("number"==typeof a||"string"==typeof a){switch(a){case "remove":g.next().remove("._select");break;default:window[f+"_select"].value(a)}return g}a=
$.extend({width:150,block:!1,title0:"",spisok:[],write:!1,multiselect:0,func:function(){},funcAdd:null},a);a.multiselect&&(a.write=!0);var l=a.width-17-5-4;a.funcAdd&&(l-=18);var m='<div class="_select" id="'+f+'_select" style="width:'+a.width+"px"+(a.block?";display:block":"")+'"><table class="seltab"><tr><td class="selsel">'+(a.multiselect?'<div class="multiTitle0">'+a.title0+"</div>":"")+'<input type="text" class="selinp" style="width:'+l+'px;cursor:default"'+(a.write?"":" readonly")+" />"+(a.funcAdd?
'<td class="seladd">':"")+'<td class="selug"></table><div class="selres" style="width:'+a.width+'px"></div></div>';g.next().remove("._select");g.after(m);var m=g.next(),k=m.find(".selres"),n=m.find(".selinp"),p=m.find(".selsel"),s=function(){for(var b=a.title0?{0:a.title0}:{},c=0;c<a.spisok.length;c++){var d=a.spisok[c];b[d.uid]=d.title}return b}(),r={},q=0;if(a.multiselect){var t=m.find(".multiTitle0");t.click(function(){$(this).css("color","#bbb");n.focus()});if(0!=h)for(m=h.split(","),e=0;e<m.length;e++)r[m[e]]=
!0,n.before('<div class="multi">'+s[m[e]]+'<span class="x" val="'+m[e]+'"></span></div>');d()}c();b(h);$(document).on("click","#"+f+"_select",function(){k.is(":hidden")&&(k.show(),$(document).on("click."+f+"_select",function(){k.hide();$(document).off("click."+f+"_select")}))}).on("click","#"+f+"_select .selun",function(){var c=parseInt($(this).attr("val"));a.multiselect&&((!a.title0&&!c||0<c)&&n.before('<div class="multi">'+s[c]+'<span class="x" val="'+c+'"></span></div>'),d(c,!0));b(c);a.func(c)}).on("click",
"#"+f+"_select .x",function(c){c.stopPropagation();c=$(this).attr("val");$(this).parent().remove();d(c,!1);b(c);a.func(c)});n.on({focus:function(){a.multiselect&&t.css("color","#bbb")},blur:function(){a.multiselect&&t.css("color","#888")},keyup:function(){if(a.multiselect)t[n.val()||q?"hide":"show"]()}});g.value=b;return window[f+"_select"]=g};
...
g();break;case "title0":q(0);a.func&&a.func(a.value);break;case "dd":q(f[1]),a.func&&a.func(a.value)}}});e.o={spisok:function(c){return void 0!=c?(a.spisok=c,b(),k.find(".process:first").remove(),a.funcKeyup?(k.find(".process_inp:first").remove(),1==s?(g(),s=0):q(0)):q(0),this):a.spisok},val:function(b){return void 0!=b?(q(b),this):a.value},title:function(){return p.val()},add:function(b){a.spisok.unshift(b);h[b.uid]=b.title;return this},process:function(){q(0);p.val("");a.spisok=[];k.find(".process").remove();
p.before("<div class=process><IMG src=/img/upload.gif></div>")},remove:function(){k.remove();return this},item:function(b){for(var c=0;c<a.spisok.length;c++){var d=a.spisok[c];if(d.uid==b)return d}return!1}};return e};
...
var d=$(this).attr("val"),g,e={op:"pagehelp_get",id:d};c();$.post(AJAX_MAIN,e,function(c){c.success?g.content.html(a(c)).find(".add").click(function(){b(c)}):g.loadError()},"json")});window.frameHidden.onresize=_fbhs;0<$("#admin").length&&$("#admin em").html(((new Date).getTime()-TIME)/1E3)});
