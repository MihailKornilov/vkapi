...
m.addClass("busy"),$.post(IMAGE_UPLOAD_PATH,a,function(a){m.removeClass("busy");a.error?d(a.error):b(a.link,a.x,a.y)},"json"))}}function f(){h=_dialog({top:20,width:610,head:"Создание снимка с вебкамеры",content:'<div id="screen"></div>',butSubmit:"Сделать снимок",butCancel:"Закрыть",submit:function(){h.process();setCookie("fotoUpload","process");n=setInterval(c,500);document.getElementById("webcam_movie")._snap(IMAGE_UPLOAD_PATH,100,0,0)}});h.content.css({padding:0,height:"457px"});p.screen=$("#screen");
...
a);var f="",g=b.val(),h=[];a.title0&&(h=[{uid:0,title:a.title0}]);for(d=0;d<a.spisok.length;d++)h.push(a.spisok[d]);for(d=0;d<h.length;d++)var n=h[d],f=f+('<div class="'+(g==n.uid?"on":"off")+(a.light?" l":"")+'" val="'+n.uid+'"><s></s>'+n.title+"</div>");b.wrap('<div class="_radio" id="'+e+'_radio">');b.after(f);c(a.func);return b};
...
$.fn._calendar=function(a){function c(){var c,d="<tr>",g=l.getFullYear(),e=l.getMonth()+1,h=l.getDate(),f;f=(new Date(a.year,a.mon-1,1)).getDay();f=0==f?7:f;var n=g==a.year&&e==a.mon,r=0==a.lost,t=a.year==k&&a.mon==m,s;c=a.year;s=a.mon;s--;0==s&&(s=12,c--);s=32-(new Date(c,s,32)).getDate();if(1<f)for(c=0;c<f-1;c++)d+="<td>";for(c=1;c<=s;c++){var u="";a.year<g?u=" lost":a.year==g&&a.mon<e?u=" lost":a.year==g&&a.mon==e&&c<h&&(u=" lost");d+='<td class="'+(!u||u&&!r?" sel":"")+(n&&c==h?" b":"")+(t&&c==
p?" set":"")+u+'"'+(!u||u&&!r?' val="'+c+'"':"")+">"+c;f++;8==f&&c!=s&&(d+="<tr>",f=1)}q.html(d).find(".sel").click(b)}function b(){k=a.year;m=a.mon;p=$(this).attr("val");t.html(p+" "+MONTH_DAT[m]+" "+k);g.val(d());a.func(d())}function d(){return k+"-"+(10>m?"0":"")+m+"-"+(10>p?"0":"")+p}function e(b){b.stopPropagation();a.mon--;0==a.mon&&(a.mon=12,a.year--);s.html(MONTH_DEF[a.mon]+" "+a.year);c()}function f(b){b.stopPropagation();a.mon++;13==a.mon&&(a.mon=1,a.year++);s.html(MONTH_DEF[a.mon]+" "+
a.year);c()}var g=$(this),h=g.attr("id"),n=g.val(),l=new Date;a=$.extend({year:l.getFullYear(),mon:l.getMonth()+1,day:l.getDate(),lost:0,func:function(){},place:"right"},a);REGEXP_DATE.test(n)&&(n=n.split("-"),a.year=n[0],a.mon=Math.abs(n[1]),a.day=Math.abs(n[2]));g.wrap('<div class="_calendar" id="'+h+'_calendar">');g.after('<div class="calinp">'+a.day+" "+MONTH_DAT[a.mon]+" "+a.year+'</div><div class="calabs"></div>');var k=a.year,m=a.mon,p=a.day,t=g.next(),r=t.next(),s,q;g.val(d());t.click(function(b){if(!r.html()){b.stopPropagation();
b=$(".calabs");for(var d=0;d<b.length;d++){var g=b.eq(d);g.parent().attr("id").split("_calendar")[0]!=h&&g.html("")}$(document).on("click.calendar"+h,function(){r.html("");$(document).off("click.calendar"+h)});a.year=k;a.mon=m;a.day=p;r.html('<div class="calcal" style="left:'+("right"==a.place?0:-64)+'px"><table class="calhead"><tr><td class="calback"><td class="calmon">'+MONTH_DEF[m]+" "+k+'<td class="calnext"></table><table class="calweeks"><tr><td>Пн<td>Вт<td>Ср<td>Чт<td>Пт<td>Сб<td>Вс</table><table class="caldays"></table></div>');
...
if(0==d.ismove){d.ismove=1;var f=0,g=setInterval(function(){var h=d.span;d.left-=d.speed*e;if(0<d.left&&1==f&&-1==e||0>d.left&&1==f&&1==e)d.left=0,d.ismove=0,d.speed=0,clearInterval(g);h[0].style.left=d.left+"px";d.speed+=2;if(d.left>d.width&&0==f&&-1==e||d.left<-d.width&&0==f&&1==e)f=1,a.year+=e,h.html(a.year),d.left=d.width*e,c.val(a.year),a.func(a.year,b)},25)}}};$("#years_"+b+" #ycenter").click(a.center);$("#years_"+b+" .but:first").mousedown(function(){allmon=1;d.next(-1)});$("#years_"+b+" .but:eq(1)").mousedown(function(){allmon=
1;d.next(1)})}};$.fn.keyEnter=function(a){$(this).keydown(function(c){13==c.keyCode&&a()});return $(this)};
$.fn.rightLink=function(a){function c(a,b){var c=a.parent();c.find("a").click(function(){c.find(".sel").removeClass("sel");$(this).addClass("sel");var g=$(this).attr("val");a.val(g);b(g,d)})}var b=$(this),d=b.attr("id"),e;if("number"==typeof a||"string"==typeof a){e=b.parent();if(e.hasClass("rightLink")){e.find(".sel").removeClass("sel");var f=e.find("a");for(e=0;e<f.length;e++){var g=f.eq(e);if(a==g.attr("val")){g.addClass("sel");break}}b.val(a)}return b}if("function"==typeof a)return c(b,a),b;a=
...
$.fn._dropdown=function(a){function c(c){b();a.nosel||(d.val(c),t.html(h[c])[(a.title0&&!c?"add":"remove")+"Class"]("grey"),s.html(h[c]))}function b(){m&&(clearTimeout(m),m=0)}var d=$(this),e=d.attr("id");if("number"==typeof a||"string"==typeof a){switch(a){case "remove":d.next().remove("._dropdown");break;default:window[e+"_dropdown"].value(a)}return d}a=$.extend({head:"",headgrey:0,title0:"",spisok:[],func:function(){},nosel:0},a);var f,g=1*d.val()||0,h=function(){for(var b=a.title0?{0:a.title0}:
{},c=0;c<a.spisok.length;c++){var d=a.spisok[c];b[d.uid]=d.title}return b}(),n=a.head||a.title0,l=a.spisok.length,k=a.title0?'<a class="ddu grey'+(l?"":" last")+(g?"":" seld")+'" val="0">'+a.title0+"</a>":"",m=0;d.val(g);for(f=0;f<l;f++){var p=a.spisok[f],k=k+('<a class="ddu'+(f==l-1?" last":"")+(g==p.uid?" seld":"")+'" val="'+p.uid+'">'+p.title+"</a>");g==p.uid&&(n=p.title)}d.next().remove("._dropdown");d.after('<div class="_dropdown" id="'+e+'_dropdown"><a class="ddhead'+(g||!a.headgrey&&!a.title0?
"":" grey")+'">'+n+'</a><div class="ddlist"><div class="ddsel">'+n+"</div>"+k+"</div></div>");var g=d.next(),t=g.find(".ddhead"),r=g.find(".ddlist"),s=r.find(".ddsel"),q=r.find(".ddu");t.click(function(){b();r.show()});s.click(function(){b();r.hide()});q.click(function(){var b=$(this),d=parseInt(b.attr("val"));c(d);a.nosel||b.addClass("seld");r.hide();a.func(d,e)}).mouseenter(function(){q.removeClass("seld")});r.on({mouseleave:function(){m=setTimeout(function(){r.fadeOut(200)},500)},mouseenter:b});
d.value=function(a){c(a);r.find(".seld").removeClass("seld");for(f=0;f<q.length;f++){var b=q.eq(f);if(b.attr("val")==a){b.addClass("seld");break}}};return window[e+"_dropdown"]=d};
(function(){var a=function(a,b){this.create(a,b);return a};a.prototype.create=function(a,b){function d(){function a(){m="showing";h.css({top:b.top,left:b.left}).animate({top:l,left:k,opacity:"show"},200,c)}function c(){m="show";if(0!=b.correct)$(document).on("keydown.hint",function(a){a.preventDefault();switch(a.keyCode){case 38:b.top--;l--;break;case 40:b.top++;l++;break;case 37:b.left--;k--;break;case 39:b.left++,k++}h.css({top:l,left:k});h.find("#correct_top").html(b.top);h.find("#correct_left").html(b.left)})}
0!=b.correct&&$(document).off("keydown.hint");switch(m){case "wait_to_hidding":clearTimeout(p);m="show";break;case "hidding":m="showing";h.stop().animate({top:l,left:k,opacity:1},200,c);break;case "hidden":0<b.delayShow?(m="wait_to_showing",p=setTimeout(a,b.delayShow)):a()}}function e(){function d(){m="hidding";h.animate({opacity:"hide"},200,function(){m="hidden";0!=b.remove&&(g.remove(),a.off(b.event+".hint"),a.off("mouseleave.hint"))})}0!=b.correct&&$(document).off("keydown.hint");"wait_to_showing"==
m&&(clearTimeout(p),m="hidden");"showing"==m&&(h.stop(),d());"show"==m&&(0<b.delayHide?(m="wait_to_hidding",p=setTimeout(d,b.delayHide)):d())}b=$.extend({msg:"Сообщение подсказки",width:0,event:"mouseenter",ugol:"bottom",indent:"center",top:0,left:0,show:0,delayShow:0,delayHide:0,correct:0,remove:0},b);var f="<TABLE class=cont_table><TR><TD class=ugttd colspan=3>"+("top"==b.ugol?"<div class=ugt></div>":"")+"<TR><TD class=ugltd>"+("left"==b.ugol?"<div class=ugl></div>":"")+"<TD class=cont>"+(1==b.correct?
...
a.before("<div class=hint>"+f+"</div>");var g=a.prev(),h=g.find(".hint_table:first");0<b.width&&h.find(".cont_table:first").width(b.width);var f=h.width(),n=h.height();h.hide().css("visibility","visible");var l=b.top,k=b.left;switch(b.ugol){case "top":l=b.top-15;n=h.find(".ugttd:first");"center"==b.indent?n.css("text-align","center"):"right"==b.indent?n.css("text-align","right"):"left"==b.indent?n.css("text-align","left"):isNaN(b.indent)||(n.css("text-align","left"),10>b.indent&&(b.indent=10),b.indent>
f&&(b.indent=f-28),h.find(".ugt:first").css("margin-left",b.indent+"px"));break;case "right":k=b.left+25;f=h.find(".ugrtd:first");"center"==b.indent?f.css("vertical-align","middle"):"bottom"==b.indent?f.css("vertical-align","bottom"):isNaN(b.indent)||(3>b.indent&&(b.indent=3),b.indent>n&&(b.indent=n-31),h.find(".ugr:first").css("margin-top",b.indent+"px"));break;case "bottom":l=b.top+15;n=h.find(".ugbtd:first");"center"==b.indent?n.css("text-align","center"):"right"==b.indent?n.css("text-align","right"):
"left"==b.indent?n.css("text-align","left"):isNaN(b.indent)||(n.css("text-align","left"),10>b.indent&&(b.indent=10),b.indent>f&&(b.indent=f-28),h.find(".ugb:first").css("margin-left",b.indent+"px"));break;case "left":k=b.left-25,f=h.find(".ugltd:first"),"center"==b.indent?f.css("vertical-align","middle"):"bottom"==b.indent?f.css("vertical-align","bottom"):isNaN(b.indent)||(3>b.indent&&(b.indent=3),b.indent>n&&(b.indent=n-31),h.find(".ugl:first").css("margin-top",b.indent+"px"))}a.off(b.event+".hint");
a.off("mouseleave.hint");a.on(b.event+".hint",d);a.on("mouseleave.hint",e);h.on("mouseenter.hint",d);h.on("mouseleave.hint",e);var m="hidden",p=0;0!=b.show&&d()};$.fn.vkHint=function(c){return new a($(this),c)}})();
$.fn._select=function(a){function c(){if(a.spisok.length){if(a.write){var b=q.val();if(b.length){var c=[];reg=RegExp(b,"i");for(k=0;k<a.spisok.length;k++){for(var b=a.spisok[k],d=b.content.split(D),g=0;g<d.length;g++){var e=d[g];if(e.length&&!D.test(e)&&reg.test(e)){d[g]=e.replace(reg,"<em>$&</em>");b.content=d.join("");c.push(b);break}}if(a.limit&&c.length==a.limit)break}a.spisok=c}}c=a.title0&&!a.write?'<div class="selun title0" val="0">'+a.title0+"</div>":"";b=a.spisok.length;a.limit&&b>a.limit&&
...
"":" readonly")+" />"+(a.funcAdd?'<td class="seladd">':"")+'<td class="selug"></table><div class="selres" style="width:'+a.width+'px"></div></div>';l.next().remove("._select");l.after(m);var s=l.next(),q=s.find(".selinp"),C=s.find(".selsel"),v=s.find(".selres"),x,y=s.find(".title0bg"),w,A=[],B={},z=0,D=/(<[\/]?[_a-zA-Z0-9=\"' ]*>)/i,E={38:1,40:1,13:1,27:1,9:1};d();if(a.multiselect){if(0!=t)for(m=t.split(","),k=0;k<m.length;k++)B[m[k]]=!0,q.before('<div class="multi">'+w[m[k]]+'<span class="x" val="'+
m[k]+'"></span></div>');g()}a.funcAdd&&s.find(".seladd").click(a.funcAdd);c();e(t);var u=q.val();$(document).on("click","#"+p+"_select .selug",h).on("click","#"+p+"_select .selsel",function(){q.focus()}).on("click","#"+p+"_select .selun",function(){f($(this))}).on("mouseenter","#"+p+"_select .selun",function(){v.find(".ov").removeClass("ov");$(this).addClass("ov")}).on("click","#"+p+"_select .x",function(b){b.stopPropagation();b=$(this).attr("val");$(this).parent().remove();g(b,!1);e(b);a.func(b,
p)});q.focus(function(){h();a.write&&y.css("color","#ccc")}).blur(function(){a.write&&y.css("color","#888")}).keyup(function(b){E[b.keyCode]||(y[q.val()||z?"hide":"show"](),u!=q.val()&&(u=q.val(),a.funcKeyup(u),l.val(0),t=0))});l.value=e;l.process=function(){q.addClass("_busy")};l.cancel=function(){q.removeClass("_busy")};l.spisok=function(b){a.spisok=b;d();c();l.cancel()};l.title=function(){return w[l.val()]};return window[p+"_select"]=l};
...
e.attr("src").replace("small","big")+'"></table><div class="about"><div class="dtime"></div></div><div class="hide"></div></div>';FB.append(f);var g=$("#foto_view");d();g.find(".head a").on("click",b);var h=e.attr("val"),e={op:"foto_load",owner:h};window.fotoViewImages&&window.fotoViewOwner==h?(a(),c()):$.post(AJAX_MAIN,e,function(b){window.fotoViewImages=b.img;window.fotoViewNum=0;window.fotoViewOwner=h;a();c()},"json")}).on("click",".check0,.check1",function(){var a=$(this),c=a.find("input"),b=
...
b.success&&a.find(".content").html(b.html)},"json"))}).on("change","._image-add input",function(){var a,c=$(this).parent(),b=c.parent();setCookie("_upload","process");a=setInterval(function(){var d=getCookie("_upload");if("process"!=d)switch(clearInterval(a),b.removeClass("busy"),c.find("input[type=file]").remove(),c.append('<input type="file" name="f1" /><input type="file" name="f2" class="f2" /><input type="file" name="f3" class="f3" />'),d=d.split("_"),d[0]){case "uploaded":d=getCookie("_param").split("_");
1==d[2]&&$("._image-add").addClass("dn");$("._image-spisok").append('<a class="_iview" val="'+d[1]+'"><div class="del'+_tooltip("Удалить",-29)+'<em></em></div><img src="'+d[0].replace(/%3A/,":").replace(/%2F/g,"/")+'" /></a>');break;case "error":switch(d[1]){default:case "0":d="Неизвестная ошибка";break;case "1":d="Неверный формат файла";break;case "2":d="Слишком маленькое изображение";break;case "3":d="Превышено количество загружаемых изображений"}$("._image-error").html(d).show().delay(1E3).fadeOut(2E3)}},
500);c.submit();b.addClass("busy")}).on("click","._image-spisok .del",function(a){a.stopPropagation();for(var c=$(this);"A"!=c[0].tagName;)c=c.parent();c.hasClass("deleting")||(c.addClass("deleting"),a={op:"image_del",id:c.attr("val")},$.post(AJAX_MAIN,a,function(a){a.success?(c.remove(),$("._image-add").removeClass("dn")):c.removeClass("deleting")},"json"))}).on("click","._iview",function(){function a(){var a=n.length,b=l+1>=a?0:l+1,c=n[l];h.find(".head em").html(1<a?"Фотография "+(l+1)+" из "+a:
"Просмотр фотографии");h.find(".dtime").html("Добавлена "+c.dtime);h.find(".image img").attr("src",c.link).attr("width",c.x).attr("height",c.y).on("load",d);h.find(".hide").html('<img src="'+n[b].link+'">')}function c(){h.find(".image").on("click",function(){var c=n.length;1==c?b():(l++,l>=c&&(l=0),a())})}function b(){h.remove();FOTO_HEIGHT=0;_fbhs();VK.callMethod("scrollWindow",g)}function d(){FOTO_HEIGHT=h.height();_fbhs()}$("#_image-view").remove();var e=$(this),f=e.attr("val"),g=VK_SCROLL;"IMG"!=
e[0].tagName&&(e=e.find("img"));e='<div id="_image-view"><div class="head"><em class="_busy">&nbsp;</em><a>Закрыть</a></div><table class="image"><tr><td><img src="'+e.attr("src").replace("-s.","-b.")+'"></table><div class="about"><div class="dtime"></div></div><div class="hide"></div></div>';FB.append(e);var h=$("#_image-view"),n=[],l=1;d();h.find(".head a").click(b);h.find("img:first").on("load",d);$.post(AJAX_MAIN,{op:"image_view",id:f},function(b){h.find("._busy").removeClass("_busy");b.success&&
(n=b.img,l=b.n,a(),c())},"json")}).ready(function(){VK.callMethod("scrollWindow",0);VK.callMethod("scrollSubscribe");VK.addCallback("onScroll",function(a){VK_SCROLL=a});FB=$("#frameBody");FH=$("#frameHidden");_fbhs();sortable();$(".pagehelp_create").click(function(){var a=$(this).attr("val"),c=_dialog({top:10,width:610,head:"Создание новой подсказки",content:'<TABLE class="pagehelp_tab"><TR><TD class="label">Страница:<TD><b>'+a+'</b><TR><TD class="label">Название:<TD><input type="text" id="name" maxlength="200"><TR><TD class="label">Содержание:<TD><TR><td colspan="2"><textarea id="pagehelp_txt"></textarea></TABLE>',
...
var d=$(this).attr("val"),e,f={op:"pagehelp_get",id:d};c();$.post(AJAX_MAIN,f,function(c){c.success?e.content.html(a(c)).find(".add").click(function(){b(c)}):e.loadError()},"json")});imageSortable();window.frameHidden.onresize=_fbhs;0<$("#admin").length&&$("#admin em").html(((new Date).getTime()-TIME)/1E3)});
