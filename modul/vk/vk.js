var VK_SCROLL = 0,
	...
	MONTH_CUT = ['янв', 'фев', 'мар', 'апр', 'май', 'июн', 'июл', 'авг', 'сен', 'окт', 'ноя', 'дек'],
	WEEK_NAME = {
		0:'вс',
		1:'пн',
		2:'вт',
	...
	function edit() {
		...
		var html =
			'<div id="attach-add-tab" class="uploaded">' +
				'<table id="tab">' +
					'<tr><td class="label r">Название файла:<td><input type="text" id="attach-name" class="w250" value="' + at.name + '" />' +
...
*/
	...
	o = $.extend({
		...
		w_sub:153,//длина селекта подрубрики
		func:function() {}
	}, o);
