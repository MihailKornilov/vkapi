(function(a){function b(){for(var a="",h=0;5>h;h++)a+=Math.ceil(15*Math.random()).toString(16);return a}function d(a,h,b,e,g){a[h]?b.apply(e):(g=g||0,1E3>g&&setTimeout(function(){d(a,h,b,e,g+1)},0))}function g(n){setTimeout(function(){var b=document.createElement("script");b.type="text/javascript";b.src=n||a.fastXDM.helperUrl;d(document,"body",function(){document.getElementsByTagName("HEAD")[0].appendChild(b)})},0)}function l(a,b){f.loaded?a.apply(b,[f]):m.push([b,a])}function p(){f.loaded=!0;for(var a=
m.length;a--;)m[a][1].apply(m[a][0],[f])}function q(a,b){l(function(c){var e=c.json.parse(a);if(e[0]){e[1]||(e[1]=[]);for(c=e[1].length;c--;)if(e[1][c]._func){var d=e[1][c]._func;e[1][c]=function(){var a=Array.prototype.slice.call(arguments);a.unshift("_func"+d);b.callMethod.apply(b,a)}}setTimeout(function(){if(!b.methods[e[0]])throw Error("fastXDM: Method "+e[0]+" is undefined");b.methods[e[0]].apply(b,e[1])},0)}})}function r(a,b){for(var c in b)a[c]&&"object"==typeof a[c]?r(a[c],b[c]):a[c]=b[c]}
if(!a.fastXDM){var k={},m=[],f={};a.fastXDM={_id:0,helperUrl:("https:"===location.protocol?"https:":"http:")+"//vk.com/js/api/xdmHelper.js",Server:function(n,h){this.methods=n||{};this.id=a.fastXDM._id++;this.filter=h;this.key=b();this.methods["%init%"]=this.methods.__fxdm_i=function(){a.fastXDM.run(this.id);if(this.methods.onInit)this.methods.onInit()};this.frameName="fXD"+this.key;this.server=!0;k[this.key]=[q,this]},Client:function(b){this.methods=b||{};this.id=a.fastXDM._id++;a.fastXDM.run(this.id);
if(0==window.name.indexOf("fXD"))this.key=window.name.substr(3);else throw Error("Wrong window.name property.");this.caller=window.parent;k[this.key]=[q,this];this.client=!0;a.fastXDM.on("helper",function(){a.fastXDM.onClientStart(this)},this);l(function(a){a.send(this,a.json.stringify(["%init%"]));var b=this.methods;setTimeout(function(){if(b.onInit)b.onInit()},0)},this)},onMessage:function(a){if(!a.data)return!1;var b=a.data.substr(0,5);if(k[b]){var c=k[b][1];if(c&&(!c.filter||c.filter(a.origin)))k[b][0](a.data.substr(6),
c)}},setJSON:function(a){f.json=a},getJSON:function(a){if(!a)return f.json;l(function(b){a(b.json)})},setEnv:function(a){for(i in a)f[i]=a[i];p()},_q:{},on:function(a,b,c){this._q[a]||(this._q[a]=[]);-1==this._q[a]?b.apply(c):this._q[a].push([b,c])},run:function(a){var b=(this._q[a]||[]).length;if(this._q[a]&&0<b)for(var c=0;c<b;c++)this._q[a][c][0].apply(this._q[a][c][1]);this._q[a]=-1},waitFor:d};a.fastXDM.Server.prototype.start=function(b,d){if(b.contentWindow)this.caller=b.contentWindow,this.frame=
b,a.fastXDM.on("helper",function(){a.fastXDM.onServerStart(this)},this);else{var c=this;d=d||0;50>d&&setTimeout(function(){c.start.apply(c,[b,d+1])},100)}};a.fastXDM.Server.prototype.append=function(a,b){var c=document.createElement("DIV");c.innerHTML='<iframe name="'+this.frameName+'" />';var d=c.firstChild,g=this;setTimeout(function(){d.frameBorder="0";b&&r(d,b);a.insertBefore(d,a.firstChild);g.start(d)},0);return d};a.fastXDM.Client.prototype.callMethod=a.fastXDM.Server.prototype.callMethod=function(){for(var b=
Array.prototype.slice.call(arguments),g=b.shift(),c=b.length;c--;)if("function"==typeof b[c]){this.funcsCount=(this.funcsCount||0)+1;var e=b[c],f="_func"+this.funcsCount;this.methods[f]=function(){e.apply(this,arguments);delete this.methods[f]};b[c]={_func:this.funcsCount}}d(this,"caller",function(){a.fastXDM.on(this.id,function(){l(function(a){a.send(this,a.json.stringify([g,b]))},this)},this)},this)};a.JSON&&"object"==typeof a.JSON&&a.JSON.parse&&a.JSON.stringify&&'{"a":[1,2,3]}'==a.JSON.stringify({a:[1,
2,3]}).replace(/ /g,"")?f.json={parse:a.JSON.parse,stringify:a.JSON.stringify}:a.fastXDM._needJSON=!0;a.postMessage?(f.protocol="p",f.send=function(a,b){a.caller.postMessage(a.key+":"+b,"*")},a.addEventListener?a.addEventListener("message",a.fastXDM.onMessage,!1):a.attachEvent("onmessage",a.fastXDM.onMessage),a.fastXDM._needJSON?(a.fastXDM._onlyJSON=!0,g()):p()):g()}})(window);"undefined"==typeof VK&&(VK={});VK._Rpc=null;VK._v=!1;VK._callbacks={};VK._initQueue=[];VK._inited=!1;
